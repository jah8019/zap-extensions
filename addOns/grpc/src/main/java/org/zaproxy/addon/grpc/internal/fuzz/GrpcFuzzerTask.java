...
public class GrpcFuzzerTask extends AbstractFuzzerTask<HttpMessage> {

    private static final Logger LOGGER = LogManager.getLogger(GrpcFuzzerTask.class);

    private final HttpFuzzerOptions options;

    public GrpcFuzzerTask(long id, GrpcFuzzer parent, HttpMessage message, List<Object> payloads) {
    ...
    @Override
    protected GrpcFuzzer getParent() {
        return (GrpcFuzzer) super.getParent();
    }
