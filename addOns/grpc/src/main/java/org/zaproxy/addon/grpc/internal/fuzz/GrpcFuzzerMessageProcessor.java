...
public interface GrpcFuzzerMessageProcessor extends FuzzerMessageProcessor<HttpMessage> {
     ...
     */
    HttpMessage processMessage(GrpcFuzzerTaskProcessorUtils utils, HttpMessage message)
     ...
     */
    boolean processResult(GrpcFuzzerTaskProcessorUtils utils, HttpFuzzResult result)
            throws ProcessingException;
}
