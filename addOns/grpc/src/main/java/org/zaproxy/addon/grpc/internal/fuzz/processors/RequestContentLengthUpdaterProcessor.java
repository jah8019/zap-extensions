...
import org.zaproxy.addon.grpc.internal.fuzz.GrpcFuzzerMessageProcessor;
import org.zaproxy.addon.grpc.internal.fuzz.GrpcFuzzerTaskProcessorUtils;
import org.zaproxy.zap.extension.fuzz.httpfuzzer.HttpFuzzResult;

public class RequestContentLengthUpdaterProcessor implements GrpcFuzzerMessageProcessor {
    ...
    @Override
    public HttpMessage processMessage(GrpcFuzzerTaskProcessorUtils utils, HttpMessage message) {
    ...
    @Override
    public boolean processResult(GrpcFuzzerTaskProcessorUtils utils, HttpFuzzResult fuzzResult) {
        return true;
    }
}
