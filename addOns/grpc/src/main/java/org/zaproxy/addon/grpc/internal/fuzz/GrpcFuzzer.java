...
public class GrpcFuzzer extends AbstractFuzzer<HttpMessage> {
    ...
    private final List<GrpcFuzzerMessageProcessor> messageProcessors;
    ...
    public GrpcFuzzer(
            ...
            List<GrpcFuzzerMessageProcessor> messageProcessors) {
        super(
                fuzzerScanName,
                fuzzerOptions,
                message,
        ...
        this.messageProcessors =
                messageProcessors.isEmpty()
                        ? Collections.<GrpcFuzzerMessageProcessor>emptyList()
    ...
    @Override
    protected GrpcFuzzerTask createFuzzerTask(
            long taskId, HttpMessage message, List<Object> payloads) {
        return new GrpcFuzzerTask(taskId, this, message, payloads);
    }
    ...
    protected void preProcessMessage(long taskId, HttpMessage message, List<Object> payloads) {
        ...
        synchronized (messageProcessors) {
            GrpcFuzzerTaskProcessorUtils utils =
                    new GrpcFuzzerTaskProcessorUtils(this, originalMessage, taskId, payloads);
            for (Iterator<GrpcFuzzerMessageProcessor> it = messageProcessors.iterator();
                    it.hasNext(); ) {
                GrpcFuzzerMessageProcessor messageProcessor = it.next();
                try {
    ...
    protected boolean processResult(long taskId, HttpFuzzResult result) {
        ...
        synchronized (messageProcessors) {
            GrpcFuzzerTaskProcessorUtils utils =
                    new GrpcFuzzerTaskProcessorUtils(
                            this,
                            originalMessage,
                            taskId,
                            result.getPayloads(),
