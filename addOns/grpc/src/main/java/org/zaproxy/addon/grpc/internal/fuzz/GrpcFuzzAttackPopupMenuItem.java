...
public class GrpcFuzzAttackPopupMenuItem extends PopupMenuItemHttpMessageContainer {

    private static final long serialVersionUID = 1L;

    private final ExtensionFuzz extensionFuzz;
    private final GrpcFuzzHandler fuzzerHandler;

    public GrpcFuzzAttackPopupMenuItem(
            ExtensionFuzz extensionFuzz, GrpcFuzzHandler fuzzerHandler) {
