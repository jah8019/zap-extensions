...
import org.zaproxy.zap.extension.fuzz.httpfuzzer.ui.HttpFuzzerErrorsTable;
...
import org.zaproxy.zap.extension.fuzz.httpfuzzer.ui.HttpFuzzerResultsTable;
...
public class GrpcFuzzResultsContentPanel extends JPanel
        implements FuzzResultsContentPanel<HttpMessage, GrpcFuzzer> {
    ...
    private static final Logger LOGGER = LogManager.getLogger(GrpcFuzzResultsContentPanel.class);
    ...
    private GrpcFuzzer currentFuzzer;
    private HttpFuzzerListener httpFuzzerListener;

    public GrpcFuzzResultsContentPanel() {
        ...
        showErrorsToggleButton.setIcon(
                new ImageIcon(
                        GrpcFuzzResultsContentPanel.class.getResource(
    ...
    public void clear(GrpcFuzzer fuzzer) {
    ...
    @Override
    public void showFuzzerResults(GrpcFuzzer fuzzer) {
